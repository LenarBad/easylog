...
public class JoinPointLogger extends JoinPointSupport {
    ...
    public Object logCallMethodLevel(ProceedingJoinPoint jp, LogCall annotation) throws Throwable {
        Method method = getMethod(jp);

        logRequest(annotation.name(), method.getName(), getMethodParameters(jp));
    ...
    public Object logCallClassLevel(ProceedingJoinPoint jp, LogCalls annotation) throws Throwable {
        Method method = getMethod(jp);
    ...
    public Object logMethodMethodLevel(ProceedingJoinPoint jp, LogMethod annotation) throws Throwable {
    ...
    public Object logMethodClassLevel(ProceedingJoinPoint jp, LogMethods annotation) throws Throwable {
        String methodName = jp.getSignature().getName();
        Map<String, Object> params = getMethodParameters(jp);
